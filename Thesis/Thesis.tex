...
\begin{document}
	...
	Some text about training 
		...
		\begin{lstlisting}[language=Python, caption=Classifier with Backbone training function, label=FC_training]
	...
	\begin{lstlisting}[language=Python, caption=Classifier with Backbone training function, label=back_training]
